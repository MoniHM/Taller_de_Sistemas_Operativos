...
3.4. Fase 4: Descarga, Compilación e Instalación de PHP 8.4.x
...
2. Script de configuración habilitando PHP-FPM, aislamiento de usuarios y los módulos de internacionalización (intl), procesamiento gráfico (external-gd), multibyte (mbstring) y manejo de calendarios:
...
3. Compilación e instalación en el prefijo unificado:
$ make
$ sudo make install

4. Despliegue del archivo de configuración para producción:
$ sudo cp php.ini-production /srv/nginx/lib/php.ini

3.5. Fase 5: Configuración de PHP-FPM y del Intercambio vía Socket UNIX
...
3.6. Fase 6: Configuración de NGINX para la Comunicación FastCGI
...
3.7. Fase 7: Automatización con Unidades de Servicio SystemD
...
3.8. Fase 8: Comprobación y Validación del Funcionamiento
